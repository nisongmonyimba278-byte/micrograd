...
The $160\times40$ validation run (400 iterations, not fully converged)
gives RMSE~$=\rmseHiRes$; the full 600-iteration schedule is
expected to reduce this further toward the $80\times20$ primary result.
