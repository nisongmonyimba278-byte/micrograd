...
not a directly manufacturable device design.
The Brinkman--SIMP model produces continuously graded density fields
that exploit diffusive mixing through intermediate-density regions;
this is a well-established modelling choice in topology optimisation
literature~\cite{borrvall2003,lazarov2016} and is explicitly acknowledged
as a surrogate.
