...
that are not directly manufacturable as binary fluid/solid geometries.
The optimised design achieves RMSE~$=\rmseTopOpt$ within the
porous-medium surrogate; hard-thresholding to a binary design
increases RMSE to $0.359$, comparable to the best parametric
Christmas-tree design ($0.329$).
The paper's contribution is the numerical methodology and open-source
infrastructure, not a manufacturable device design;
