...
\begin{enumerate}
    ...
    \item \textbf{Documented heuristic continuation schedule.}
          ...
          with its empirical motivation (Table~\ref{tab:continuation}).
          The hybrid OC/MMA split is a heuristic engineering choice;
          pure MMA is a valid simpler alternative.
