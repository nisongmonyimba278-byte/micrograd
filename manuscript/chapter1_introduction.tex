...
\paragraph{Scope.}
\texttt{micrograd} is a surrogate-based optimisation tool
calibrated for engineering-resolution meshes ($\Delta y\approx25\,\mu$m).
It produces Brinkman--SIMP porous optima that serve as starting
points for binary realisation or experimental iteration~\cite{borrvall2003,wang2011}.
The paper's contribution is a documented, tested, and reproducible
open-source implementation of the complete pipeline;
the individual algorithmic components are drawn from
