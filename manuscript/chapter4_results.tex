...
\begin{figure}[t]
    ...
    \caption{Performance comparison on the $80\times20$ Brinkman mesh.
             Red circles: Christmas-tree designs across eight permeability widths
...
Importantly, the threshold-projected optimised design (RMSE~$=\rmseBinaryBrinkman=0.359$)
performs comparably to the best physically realisable Christmas-tree configuration
