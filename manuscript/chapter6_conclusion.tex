...
\begin{enumerate}
    ...
    \item \textbf{Documented heuristic continuation schedule.}
          Five components documented with empirical motivation
          (Table~\ref{tab:continuation});
          reduces gray fraction from $\grayShortRun$ to $\grayFrac$.
          The OC/MMA split is a heuristic; pure MMA is a
          valid simpler alternative (not systematically compared).
