...
Gradient correctness is verified by finite-difference Taylor test (slope $\approx 2.0$)
functional that yields second-order convergence
(gradient-descent verified, see Section~\ref{sec:taylor_test}),
confirming consistently implemented chain-rule propagation through the filter and projection.
